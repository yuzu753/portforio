...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.4/activejob/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.4/activejob" } if s.respond_to? :metadata=
